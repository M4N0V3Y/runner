...
@XmlRootElement(name = "retornoNFEINF")
public class RetornoNFEINF {
    ...
    @XmlElementRef(name = "CHNFE", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> chnfe;
     ...
     * 
     */
    public JAXBElement<String> getCHNFE() {
        return chnfe;
    }
     ...
     * 
     */
    public void setCHNFE(JAXBElement<String> value) {
        this.chnfe = value;
    }
